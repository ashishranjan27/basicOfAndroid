package com.example.databindingfragment.model
...
object DataProvider {
    ...
    init {
        ...
        addProduct("sweater101",
            "V-neck sweater",
            "This medium-weight sweater, made from organic knitted cotton and bamboo, is the perfect solution to a chilly night at the campground or a misty walk on the beach.Now I also want to test the scroll event here so for this i have writing some " +
                    "random text so that it can be extended so much that it should be scroable and through this we can learn the concept of scrolling also with full understanding",
            65.0, 63.9, 3.0F, 64)
        addProduct("shirt104",
            "Polo shirt",
